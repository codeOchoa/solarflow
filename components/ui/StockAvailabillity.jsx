...
// Name of the component: StockAvailabillity.jsx
...
const StockAvailabillity = ({ stock, inStock }) => {
    return (
        <p className="text-xl flex gap-x-2 max-[500px]:justify-center">
            ...
            {inStock === 1 ? (
                ...
                <span className="text-error flex items-center gap-x-1">
                    Out of stock <FaXmark />
                </span>
            )}
        </p>
    );
